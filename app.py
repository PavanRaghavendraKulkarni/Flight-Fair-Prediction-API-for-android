...
def predict(data):
        ...
        print(date_dep)
        Journey_day = int(pd.to_datetime(date_dep, format='%d-%m-%Y').day)
        Journey_month = int(pd.to_datetime(date_dep, format='%d-%m-%Y').month)

        # Departure :
        time_dep = data['time_dep']
        ...
        Arr_Hour = int(pd.to_datetime(date_arr, format='%H:%M').hour)
        Arr_min = int(pd.to_datetime(date_arr, format='%H:%M').minute)
